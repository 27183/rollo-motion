                ...
                <React.Fragment>
                    ...
                    <View style={{ flex: 3 / 10, alignItems: "center" }}>
                        <TouchableOpacity disabled={this.props.photoPickDisabled} onPress={this.props.pickImage}>
                            <View>
                                <Image style={styles.avatar} source={this.props.uploading ? require("../../../../assets/loading.gif") : { uri: this.props.image || "https://pngimage.net/wp-content/uploads/2018/05/default-user-profile-image-png-2.png" }} />
                    ...
                    <TouchableOpacity disabled={this.props.uploading || (!this.props.text)} style={{ backgroundColor: "#33aadc", width: 300, height: 40, borderRadius: 10, flexDirection: "row", justifyContent: "center", alignItems: "center", top: 20, alignSelf: "center" }} onPress={() => this.props.signUserIn(this.props.token, this.props.text, this.props.phoneNumber)}>
